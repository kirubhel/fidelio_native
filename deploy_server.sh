...
echo -e "${GREEN}Done! Server is running at http://${SERVER_IP}:8083${NC}"
echo -e "${GREEN}Please ensure your reverse proxy maps https://learningcloud.et/native_app/ to http://localhost:8083/${NC}"
